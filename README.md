...
let cannot be used for mutable functions
struct will be destroyed and created with updated properties when mutable keyword is used.
struct has passed by value whereas classes are passed by reference
